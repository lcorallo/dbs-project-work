...
AFTER INSERT OR UPDATE OF teamRef ON OPERATION_ORDER
FOR EACH ROW
BEGIN
    DECLARE
...
CREATE OR REPLACE INDEX IDX_TEAM ON TEAM (score);
/

CREATE OR REPLACE INDEX IDX_ORDER ON OPERATION_ORDER (code);
INDEXTYPE IS DOMAIN_HASH;
/